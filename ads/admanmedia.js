...
export function admanmedia(global, data) {
  ...
  // loadScript(global, `http://localhost:4000/pubgo?id=${encodedId}`, () => {
  loadScript(global, `https://pub.admanmedia.com/go?id=${encodedId}`, () => {
  ...
  // loadScript(global, `http://localhost:4000/go?replay=true&vast=${encodedVast}id=${encodedId}`, () => {
  //   const pattern = `script[src$="id=${encodedId}"]`;
